# Project 3: Monte Carlo & Stochastic Volatility
...
* **`hm3_ex1.m`**: MATLAB implementation for European call option pricing via Monte Carlo simulation and finite difference approximations.
* **`hm3_ex2c.m`**: MATLAB implementation incorporating basic stochastic volatility modeling.
* **`hm3_ex2d.m`**: Advanced simulation scaling across thousands of paths to verify volatility model convergence.
