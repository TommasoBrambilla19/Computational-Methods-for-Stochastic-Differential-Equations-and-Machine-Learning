# Project 2: Numerical Solutions for SDEs
...
* **`code_ex1_exact_sol.m`**: MATLAB implementation generating the exact analytical solution for an SDE to establish a baseline.
* **`code_ex1_reference_sol.m`**: MATLAB implementation generating the numerical reference solution using a fine time discretization.