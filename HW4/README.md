# Project 4: Gibbs Sampling & Parameter Estimation
...
* **`hw4_gibbs.m`**: MATLAB implementation of the Gibbs Sampling algorithm to iteratively draw samples from conditional distributions and visualize the posterior predictive distribution.